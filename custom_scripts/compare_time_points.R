...
# UpSet plot for all time points for each virus
virus.dge.binary <- list2binary(lapply(res.list.filter, "[[", "SYMBOL"))
par(mfrow=c(3,3))
...
# Compare infected 24h vs. Mock with infected 24h vs. BPL-treated for each virus
LFC.cut <- 1
