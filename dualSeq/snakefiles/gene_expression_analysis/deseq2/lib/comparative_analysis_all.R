...
library(tidyr)
library(gtools)
<<<<<<< HEAD:dge_pipeline/snakefiles/analyses/deseq2/lib/comparative_analysis_all.R
library(gplots)
library(openxlsx)
library(DESeq2)
library(reshape2)
...
>>>>>>> new_mapping_strategy:dualSeq/snakefiles/gene_expression_analysis/deseq2/lib/comparative_analysis_all.R
# Heatmap
# Upset
# ORA
# STRING network
